...
------------- | :---------------------------------------------------------------: | -----------------:
name          |                               Name                                |               Text
application   |                  Application of the subscription                  |      skydipper
...
```shell
curl -X POST https://api.skydipper.com/v1/subscriptions \
...
```shell
curl -X GET https://api.skydipper.com/v1/subscriptions/:id/confirm
```
...
```shell
curl -X GET https://api.skydipper.com/v1/subscriptions \
-H "Authorization: Bearer <your-token>"
```
...
```shell
curl -X PATCH https://api.skydipper.com/v1/subscriptions/:id/send_confirmation \
-H "Authorization: Bearer <your-token>"
```
...
```shell
curl -X PATCH https://api.skydipper.com/v1/subscriptions/:id \
-H "Authorization: Bearer <your-token>"
```
...
```shell
curl -X GET https://api.skydipper.com/v1/subscriptions/:id/unsubscribe \
-H "Authorization: Bearer <your-token>"
```
...
```shell
curl -X DELETE https://api.skydipper.com/v1/subscriptions/:id/unsubscribe \
-H "Authorization: Bearer <your-token>"
```
