...
```shell
curl -X GET https://api.skydipper.com/v1/topic -H 'Authorization: Bearer exampleToken' 
```
...
```shell
curl -X POST https://api.skydipper.com/v1/topics/10/clone -H 'Authorization: Bearer exampleToken' 
```
...
```shell
curl -X POST https://api.skydipper.com/v1/topics/10/clone-dashboard -H 'Authorization: Bearer exampleToken' 
```
