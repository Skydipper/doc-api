...
```shell
curl -X POST https://api.skydipper.com/v1/collection \
...
```shell
curl -X POST https://api.skydipper.com/v1/collection/:id/resource \
-H "Authorization: Bearer <your-token>" \
-H "Content-Type: application/json"  -d \
 '{
   "type": "<type>",
...
```shell
curl -X GET https://api.skydipper.com/v1/collection \
-H "Authorization: Bearer <your-token>"
```
...
```shell
curl -X GET https://api.skydipper.com/v1/collection/:id \
-H "Authorization: Bearer <your-token>"
```
...
```shell
curl -X DELETE https://api.skydipper.com/v1/collection/:id \
-H "Authorization: Bearer <your-token>"
```
...
```shell
curl -X DELETE https://api.skydipper.com/v1/collection/:id/resource/:resourceType/:resourceId \
-H "Authorization: Bearer <your-token>"
```
