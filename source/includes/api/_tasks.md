...
type              |  Task type - see full list [here](https://github.com/skydipper/doc-importer-messages/blob/master/task.messages.js#L4) |   Text
message           |                        Task message, which parametrizes the task                     |   Object
status            |  Status of the task - see full list [here](https://github.com/skydipper/doc-orchestrator/blob/master/app/src/app.constants.js#L3) |    Text
...
```shell
curl -X GET https://api.skydipper.com/v1/doc-importer/task
```
...
```shell
curl -X GET https://api.skydipper.com/v1/doc-importer/task?type=TASK_OVERWRITE
```

> Return the tasks with status SAVED

```shell
curl -X GET https://api.skydipper.com/v1/doc-importer/task?status=SAVED
```

> Return the tasks created on Feb 1st 2019

```shell
curl -X GET https://api.skydipper.com/v1/doc-importer/task?createdAt=2019-02-01
```

> Return the tasks last updated between Jan 2nd and Feb 2nd 2019

```shell
curl -X GET https://api.skydipper.com/v1/doc-importer/task?updatedAfter=2019-01-02&updatedBefore=2019-02-02
```

> Return the tasks last updated before and Feb 2nd 2019 and with status ERROR

```shell
curl -X GET https://api.skydipper.com/v1/doc-importer/task?updatedBefore=2019-02-02&status=ERROR
```
...
```shell
curl -X GET https://api.skydipper.com/v1/doc-importer/task/55b02cfd-dabf-4ad0-a04d-5501cf248a0c
```
...
```shell
curl -X DELETE https://api.skydipper.com/v1/doc-importer/task/<task_id> \
